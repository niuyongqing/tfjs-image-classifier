  ...
  <div class="h-screen w-screen flex flex-col font-sans overflow-hidden">
    ...
    <header class="bg-gray-900 text-white h-12 flex items-center justify-between px-4 shadow-lg z-50 flex-none">
      <div class="flex items-center gap-3">
        <div
          class="w-8 h-8 rounded bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center font-bold shadow">
          TF
        </div>
        <h1 class="text-base font-bold tracking-wider opacity-90">TensorFlow.js 图像分类系统 <span
            class="text-xs font-normal opacity-60 ml-2">Element Plus Edition</span></h1>
      </div>
